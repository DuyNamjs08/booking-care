...
export const dataDepartment = [
    {id:1 , title :'Cơ Xương Khớp' , img:carousel1 , path:'/chuyen-khoa/co-xuong-khop'},
    {id:2 , title :'Thần kinh' , img:carousel2 , path:'/chuyen-khoa/than-kinh'},
    {id:3 , title :'Tiêu hoá' , img:carousel3 , path:'/chuyen-khoa/tieu-hoa'},
    {id:4 , title :'Tim mạch' , img:carousel4 , path:'/chuyen-khoa/tim-mach'},
    {id:5 , title :'Tai mũi họng' , img:carousel5 , path:'/chuyen-khoa/tai-mui-hong'},
    {id:6 , title :'Cột sống ' , img:carousel2 , path:'/chuyen-khoa/cot-song '},
    {id:7 , title :'Y học cổ chuyền' , img:carousel1 , path:'/chuyen-khoa/y-hoc-co-chuyen'},
    {id:8 , title :'Châm cứu' , img:carousel3 , path:'/chuyen-khoa/cham-cuu'},
    {id:9 , title :'Sản phụ khoa' , img:carousel4 , path:'/chuyen-khoa/san-phu-khoa'},
]
export const dataBreadCrumbs = [
    {id:1 , path:'/chuyen-khoa' , title:'Chuyên khoa' , childs:dataDepartment}
]